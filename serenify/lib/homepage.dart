...
import 'tictac.dart';
import 'snkae.dart';
import 'popgame.dart'; // Import the PopGame screen
import 'Survey2.dart'; // Import the Survey2 screen
...
class _HomePageState extends State<HomePage> {
  ...
  int _stressPercentage = 0; // Default stress percentage
  ...
  Future<void> _loadStressLevel() async {
    ...
    setState(() {
      _stressPercentage = prefs.getInt('stressLevel') ??
          75; // Use default value if not set
    });
  }
                ...
                Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20), // Increased space above the buttons
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                      ...
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => QuizSelectionScreen() // Navigate to Survey2Page
                            ),
                          );
                        },
